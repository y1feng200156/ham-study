...
function MagneticLoopAntenna() {
  return (
    <group>
      {/* Main Loop (Vertical in XY plane) */}
      <mesh position={[0, 0, 0]}>
      ...
      <group position={[0, 2, 0]}>
        ...
        {/* Capacitor Plates Detail (simplified) */}
      ...
      <group position={[0, -2, 0]}>
        {/* Small loop is usually 1/5 diameter */}
        <mesh position={[0, 0.4, 0]}>
          <torusGeometry args={[0.4, 0.03, 16, 50]} />
    ...
    <>
      ...
      <div className="mt-3 mb-2 space-y-1.5 text-xs border-t border-gray-600 pt-2">
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span>{t("magneticLoopAntenna.strength")}</span>
        </div>
      </div>
    </>
  );
