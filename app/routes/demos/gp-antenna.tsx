      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            它由一根垂直的 1/4 波长振子和数根（通常 3-4 根）水平或下倾的地网（Radials）组成。
          </p>
          <ul>
             <li><strong>人造地网:</strong> 那些径向伸出的金属杆模拟了一个完美的“地面”，就像镜子一样反射出另一半天线（镜像），从而形成了等效的偶极子。</li>
             <li><strong>发射仰角:</strong> 具有较低的发射仰角，这意味着大部分能量是贴着地面或水平方向发射出去的，非常适合 DX (远距离) 通信和本地覆盖。</li>
          </ul>
          ...
          <h3>极化特性与应用</h3>
           <ul>
            ...
            <li>
                <strong>全向性 (Omnidirectional):</strong> 在水平方向上360度均匀辐射，没有方向性。
            </li>
             <li>
                <strong>应用:</strong> 本地 V/UHF 中继通讯、车载天线、以及作为 DX 通信的基础天线（特别是低波段如 40m/80m）。
            </li>
          </ul>
        </div>
      </div>
