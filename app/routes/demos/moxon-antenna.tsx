    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <ul>
             <li><strong>卓越的前后比 (F/B):</strong> Moxon 的最大特点是其极高的前后比，能极其有效地抑制来自背后的干扰信号。</li>
             <li><strong>紧凑尺寸:</strong> 其跨度仅为同频段全尺寸八木的 70% 左右，非常适合空间受限的场合。</li>
             <li><strong>宽带宽:</strong> 可以在很宽的频率范围内保持良好的驻波比。</li>
          </ul>
